...
const EventDetails = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="max-w-7xl mx-auto grid lg:grid-cols-[2fr_1fr] gap-3 px-4">
        <div className="max-w-5xl  py-10 ">
          ...
          <div className="">
            ...
            <img
              src={event.img}
              alt={event.title}
              className="w-full h-100 object-cover object-top rounded-xl"
            />
          </div>
          <div className="grid  gap-6  ">
            <div className="py-5 max-w-4xl ">
              <ul className="flex gap-7 px-2 border-b-2  border-gray-200">
                <li className="border-[#2B7FFF] py-2 transition duration-300 hover:border-b font-bold">
                  About
                </li>
                <li className="border-[#2B7FFF] py-2 transition duration-300 hover:border-b font-bold">
                  Heighlights
              ...
              <p className="text-[15px] font-medium text-gray-500">
                ...
                hogh-energy perfrmances and a crowd like no other. Food, drinks,
                and merchandise available!
              </p>
              <div className="grid lg:grid-cols-[1.1fr_1.4fr_1.1fr_1.1fr] md:grid-cols-2 pt-5 pb-3 h-20">
              ...
              <h3 className="text-[18px] pt-5 pb-4 font-bold">
                Event Highlights
              </h3>
              <div className="flex flex-col">
                <ul className="flex gap-3">
                  <li className="bg-blue-100 py-1 rounded-2xl px-3 text-[14px] font-bold text-[#4B49DE]">
                    Live Music
                  </li>
                  <li className="bg-blue-100 py-1 rounded-2xl px-3 text-[14px] font-bold text-[#4B49DE]">
                    Top Rock Bands
              ...
              <div className="py-2">
                ...
                <p className="text-[15px] font-medium text-gray-500">
                  Evently Team organizes some of the most exciting and memorable
                  events across India. From live concerts to tech conferences,
                  we bring people together for unforgettable experiences. Join
                  us and be part of moments that turn into lasting memories.
                </p>
              </div>

              <div className="py-4 mt-6 px-4 border  border-gray-100 shadow-md   rounded-2xl h-95">
        ...
        <div className=" max-w-full  py-20">
          <div className="m-2 py-3 border border-gray-300 rounded-2xl px-3 gap-2 flex flex-col">
            <h3 className="text-[18px] pt-5 pb-1 font-bold">
              Get Your Tickets
            </h3>
            ...
            <div className="flex flex-col gap-1">
              ...
              <input type="number" className="outline-0 rounded w-20  " />
              <button
                onClick={() => {
                  setOpenBooking(!OpenBooking);
                }}
                className="mt-4 bg-[#4B49DE] text-white font-bold p-2 rounded-xl active:scale-95 transition duration-300 transform"
              >
                Book Now
              </button>
              ...
              {OpenBooking && (
                <div className="fixed flex  justify-center  items-center inset-0 bg-black/40">
                  <div className=" bg-white w-[60%] h-[90%] gap-3 p-5 rounded-2xl border-gray-300  flex border relative">
                    <div className=" bg-white  w-[68%]  ">
                      <div
                      ...
                      <div className="border mt-3 border-gray-300 p-4 rounded-2xl">
                        ...
                        <div>
                          <div className="flex mt-3 gap-3 border-2 px-4 hover:shadow-sm border-gray-100 p-2 rounded-xl items-center w-full ">
                            <input type="radio" />
                            <span className="border border-gray-100 rounded-xl p-3 bg-[#F4F2FC] w-10 h-10  ">
                            ...
                            <div className="flex items-center">
                              <div className="flex justify-end items-center gap-3 w-67">
                                <p className="font-bold text-[#5B42E7]">₹799</p>
                          ...
                          <div className="flex mt-3 gap-3 border-2 hover:shadow-sm border-gray-100 px-4 justify-between p-2 rounded-xl items-center w-full ">
                            ...
                            <div className="w-70 leading-4">
                              ...
                              <p className="text-[11px] text-gray-500 font-medium">
                                Early entery,premium viewing & lounge access
                              </p>
                            </div>
                            <div className="flex items-center">
                        ...
                        <div className="flex gap-3 px-2 w-full justify-between">
                          <div className="flex flex-col gap-1">
                            <p className="font-semibold text-[13px]">
                              Full Name
                            </p>
                            <div className="flex items-center gap-1 border w-40 px-2 p-3 border-gray-300 rounded-md">
                              <LuUser />
                              <input
                                type="text"
                          ...
                          <div className="flex flex-col gap-1">
                            <p className="font-semibold text-[13px]">Email</p>
                            <div className="flex items-center gap-1 border w-40 px-2 p-3 border-gray-300 rounded-md">
                              <MdOutlineMail />
                              <input
                                type="text"
                        ...
                        <div>
                          <h3 className="font-bold py-3">3. Payment Details</h3>
                          ...
                          <div className="border border-gray-300 rounded-xl w-full p-3 px-4 flex justify-between mt-3">
                            <div className="flex gap-2 items-center ">
                              ...
                              <div>
                                ...
                                <p className="font-medium text-[12px]">
                                  Your payment information is safce with us
                                </p>
                              </div>
                            </div>
                            <div className="flex flex-col gap-1">
                    ...
                    <div className="bg-white  ">
                      <div className="py-3 mt-20">
                        <img src={event.img} alt="" className="rounded-xl" />
                      </div>
                      <div className="flex flex-col gap-2">
                        <p className="text-[16px] font-bold">Order Summary</p>
                        <div className="flex justify-between">
                        ...
                        <div className="flex justify-between">
                          ...
                          <p className="text-[12px] font-bold ">24 May, 2024</p>
                        </div>
                        <div className="flex justify-between">
                          <p className="text-[12px] font-bold text-gray-500 ">
                            Time
                        ...
                        <div className="flex justify-between">
                          ...
                          <p className="text-[12px] font-bold ">Delhi, India</p>
                        </div>
                        <div className="flex justify-between">
                          <p className="text-[12px] font-bold text-gray-500 ">
                            Tickets
                      ...
                      <div className="flex flex-col gap-1">
                        <div className="flex justify-between">
                          ...
                          <p className="text-[12px] font-bold "> ₹1,598</p>
                        </div>
                        <div className="flex justify-between">
                      ...
                      <div className="flex justify-between ">
                        <p className="text-[15px] font-bold">Total Payable</p>
                      ...
                      <div className="border mt-2  p-2 border-gray-300 rounded-xl flex items-center gap-2">
                        ...
                        <div>
                          <p className="font-bold text-[14px]">Need Help?</p>
          ...
          <div className="border border-gray-300 rounded-2xl px-5 shadow py-3 m-2 my-4 gap-4 flex flex-col ">
          ...
          <div className="border border-gray-300 rounded-2xl m-2 px-5 shadow py-3 flex gap-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="flex items-center gap-1">
                ...
                <p className="text-[13px] text-gray-500">4.8 (230 events)</p>
              </span>
